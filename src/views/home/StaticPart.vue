<template>
    ...
    <!-- banner -->
    <div class="banner">
      <img src="http://47.101.182.200:9000/vue3/banner.jpeg"
        class="banner__img">
    </div>
        <!-- icon九宫格区 -->
    <div class="icons">
      <div class="icons__item" v-for="item in iconsList" :key="item.desc">
        <img class="icons__item__img" :src="`http://47.101.182.200:9000/vue3/icon/${item.imgName}.png`">
